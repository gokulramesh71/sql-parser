  ...
  code = """
    ...
    (function(root) {
      ...
      if(typeof define === 'function' && define.amd) {
        console.log("define is there", SQLParser, define);
        define(function() { return window.SQLParser = SQLParser });
      } else { console.log("else is there", SQLParser, root);root.SQLParser = SQLParser }
    }(this));
  """
